...
def load_models():
    ...
    vit.load_state_dict(torch.load("vit_plant_model.pth", map_location=DEVICE))
    vit.eval().to(DEVICE)
...
# ========================
# METRICS (FROM PREVIOUS EVAL)
# ========================
vit_metrics = {"Accuracy": 0.97, "Precision": 0.96}  # replace with real values
